...
CREATE TABLE "RespostaSubTarefa" (
    ...
    CONSTRAINT "RespostaSubTarefa_subTarefaId_fkey" FOREIGN KEY ("subTarefaId") REFERENCES "SubTarefa" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "RespostaSubTarefa_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "Usuario" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
